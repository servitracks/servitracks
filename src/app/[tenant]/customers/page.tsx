  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        {[
          { label: "Total Clientes", value: tenantCustomers.length, icon: Users, iconBg: "bg-slate-100 text-slate-700 border-slate-200/60" },
          { label: "Nuevos este mes", value: newThisMonth, icon: TrendingUp, iconBg: "bg-emerald-50 text-emerald-600 border-emerald-200/60" },
          { label: "Vehículos Registrados", value: tenantVehicles.length, icon: Car, iconBg: "bg-blue-50 text-blue-600 border-blue-200/60" },
        ].map((kpi) => (
          <div 
            key={kpi.label} 
