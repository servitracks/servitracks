...
ALTER TABLE IF EXISTS public.maintenance_history DROP CONSTRAINT IF EXISTS maintenance_history_vehicle_id_fkey;
ALTER TABLE IF EXISTS public.appointments DROP CONSTRAINT IF EXISTS appointments_vehicle_id_fkey;
ALTER TABLE IF EXISTS public.evaluations DROP CONSTRAINT IF EXISTS evaluations_vehicle_id_fkey;
...
ALTER TABLE IF EXISTS public.maintenance_history ALTER COLUMN vehicle_id TYPE text USING vehicle_id::text;
ALTER TABLE IF EXISTS public.appointments ALTER COLUMN vehicle_id TYPE text USING vehicle_id::text;
ALTER TABLE IF EXISTS public.evaluations ALTER COLUMN vehicle_id TYPE text USING vehicle_id::text;
